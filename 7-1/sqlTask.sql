...
--VALUES ('M001', 'マフラー', 4500, '2022-12-21');
...
--間違えてEA01のすべての商品を在庫１０にしてしまったので以下のコードで修正します
UPDATE stock_table
SET quantity = 17, update_day = CURRENT_DATE
WHERE goods_code = 'K206' AND store_code = 'EA01';

UPDATE stock_table
SET quantity = 15, update_day = CURRENT_DATE
WHERE goods_code = 'P093' AND store_code = 'EA01';
